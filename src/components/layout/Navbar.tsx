        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='hidden md:block'>
            <div className='flex items-center space-x-6'>
              ...
              <Link
                href='/verticals'
                className={`${pathName === '/verticals' ? 'bg-white/10' : ''} rounded-xl px-4 py-2 text-sm font-medium text-white/80 transition-colors hover:bg-red-500 hover:text-black`}
              >
                Verticals
              </Link>
              <Link
                href='/team'
                className={`${pathName === '/team' ? 'bg-white/10' : ''} rounded-xl px-4 py-2 text-sm font-medium text-white/80 transition-colors hover:bg-red-500 hover:text-black`}
              >
                Team
              </Link>
              <Link
                href='/achievements'
                className={`${pathName === '/achievements' ? 'bg-white/10' : ''} rounded-xl px-4 py-2 text-sm font-medium transition-colors hover:bg-red-500 hover:text-black`}
              >
                Achievements
              </Link>
